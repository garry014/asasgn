<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="_200115X_AS.Login" %>
...
<head runat="server">
    ...
    <script>
        grecaptcha.ready(function () {
            grecaptcha.execute('6Lezh_8dAAAAAEJeJ7mM_CwhUg_kx7Un03yZ3Sqk', { action: 'Login' }).then(function (token) {
